...
class IMRPhenomHM(WaveFormModel):
    ...
    def Phi(self, f, **kwargs):
        ...
        :rtype: dict(cupy.ndarray, cupy.ndarray, cupy.ndarray, cupy.ndarray, cupy.ndarray, cupy.ndarray)
    ...
    def _RDfreqCalc(self, finalmass, finalspin, l, m):
        ...
        :param cupy.ndarray or float finalmass: Mass(es) of the final object(s).
        :param cupy.ndarray or float finalspin: Spin(s) of the final object(s).
